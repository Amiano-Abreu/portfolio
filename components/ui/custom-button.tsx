...
interface ButtonProps {
    text: string;
    icon: ReactNode;
    scrollToContact: MouseEventHandler<HTMLAnchorElement>;
}

const CustomButton: FC<ButtonProps> = ({ text, icon, scrollToContact }) => {
    return (
        <a className="custom-btn" onClick={scrollToContact}>
